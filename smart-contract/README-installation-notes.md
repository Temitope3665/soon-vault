...
### Git Repository
Clone the 'yield-aggragator-sc' repository into your development machine:
```bash
$ cd /path/to/your/work/folder/
$ git clone https://github.com/solana-labs/yield-aggragator-sc.git
$ cd yield-aggragator-sc
```
