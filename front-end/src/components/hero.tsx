...
export default function Hero() {
  ...
  const programId = new PublicKey(
    '5UaBm7pz2XKiTW8jZM2ic6pMVqFSUqmYvyuntF6cm4xX' // change this to your program ID
  );
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col items-center justify-center">
      <div className="text-center text-black mb-4">Check the console for actions.</div>
      <div className="text-center text-black mb-4">Make sure you are connected to the wallet.</div>
